...
namespace GameFramework.DataTable
{
    ...
    public interface IDataTable<T> : IEnumerable<T> where T : IDataRow
    {
        ...
        /// 增加数据表行。
        /// </summary>
        /// <param name="dataRowString">要解析的数据表行数据源。</param>
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否增加数据表行成功。</returns>
        bool AddDataRow(object dataRowString, object userData);
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否增加数据表行成功。</returns>
        bool AddDataRow(object dataRowBytes, int startIndex, int length, object userData);
